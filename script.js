...
searchInput.addEventListener('keypress', (e) => {
    if (e.key === 'Enter') {
        // Ici, vous pourriez ajouter la logique pour rechercher une ville
        console.log('Recherche pour:', searchInput.value);

        // Exemple de logique pour récupérer les données météo d'une ville
        const apiKey = 'votre_clé_api'; // Remplacez par votre clé API
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                // Vous pourriez avoir besoin de récupérer les prévisions horaires via une autre API
            })
            .catch(error => {
